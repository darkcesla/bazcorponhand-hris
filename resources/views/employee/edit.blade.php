                        ...
                        <div class="container-fluid px-4">
                            ...
                            <div class="tab-content" id="employeeTabContent">
                                <div class="tab-pane fade show active" id="personal" role="tabpanel"
                                    ...
                                    @include('employee.forms.edit.personal')
                                </div>
                                <div class="tab-pane fade" id="employment" role="tabpanel" aria-labelledby="employment-tab">
                                    @include('employee.forms.edit.employment')
                                </div>
                                <div class="tab-pane fade" id="education" role="tabpanel" aria-labelledby="education-tab">
                                    @include('employee.forms.edit.education')
                                </div>
                                <div class="tab-pane fade" id="bank" role="tabpanel" aria-labelledby="bank-tab">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="col-form-label form-label">Bank Name</label>
                                            <input name="bank_name" type="text" class="form-control" value="{{ $employee->bank_name }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="col-form-label form-label">Account Number</label>
                                            <input name="account_number" type="text" class="form-control" value="{{ $employee->account_number }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="col-form-label form-label">Account Name</label>
                                            <input name="account_name" type="text" class="form-control" value="{{ $employee->account_name }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input name="emergency_contact_name"
                                                value="{{ $employee->emergency_contact_name }}" type="text"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-3">
