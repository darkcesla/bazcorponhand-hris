<div class="row">
    <div class="col-md-6">
        ...
        <input name="employee_no" type="text" class="form-control" value="{{ $employee->employee_no }}">
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <label class="col-form-label form-label">Access Card</label>
        <input name="access_card_id" type="text" class="form-control" value="{{ $employee->access_card_id }}">
    </div>
</div>
<div class="row">
    <div class="col-md-6">
