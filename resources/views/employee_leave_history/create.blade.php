    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.employee_leave_history.store') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="container-fluid px-4">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input name="day_count_display" type="text" class="form-control" disabled>
                                    <input name="day_count" type="hidden">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
