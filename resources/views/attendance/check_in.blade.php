    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('attendance.checkin_process', ['id' => $attendance->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="container-fluid px-4">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="hidden" id="latitude" name="check_in_latitude">
                                    <input type="hidden" id="longitude" name="check_in_longitude">
                                </div>
                                <div class="col-md-8">
